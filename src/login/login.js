...
function LoginPage() {
    ...
    <div className='bg-black'>
        ...
        <div className='mx-auto' style={{maxWidth:650}}>
            ...
            <div className='loginHits text-center fw-bold'>To continue, log in to GoodSounds.</div>
        <div className='loginInputLayout'>
            ...
            <div className='loginInputLayout'>
                <label htmlFor="password" className="loginHits">Passwords</label>
            ...
            <hr/>
            <div className='loginHits text-center fw-bold'>Don't have a account for GoodSounds?</div>
            <button className='signupButton'>Sign Up for Account</button>
        </div>

        <div className='flex-column align-content-center align-items-center'>
