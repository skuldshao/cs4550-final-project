    ...
    return (
        <div className="d-flex justify-content-between mt-3 mb-3">
            <div className="d-flex justify-content-start">
                <Link to={`/profile/${item.userId}`} className="text-white text-decoration-none">
                    <img src={`/images/${item.avatarIcon}`} height="50px" width="50px" className="rounded-circle"/>
                </Link>
                <Link to={`/profile/${item.userId}`} className="text-white text-decoration-none align-self-center">
